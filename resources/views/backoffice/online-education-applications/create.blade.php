...
<div class="board-container education-applications">
    <div class="board-header">
        <a href="{{ $program ? route('backoffice.online-education-applications.show', $program->id) : route('backoffice.online-education-applications.index') }}" class="btn btn-secondary btn-sm">
    ...
    <div class="board-card">
        <div class="board-card-body">
            @include('backoffice.online-education-applications._form', ['isEdit' => false, 'application' => null, 'program' => $program, 'programs' => $programs ?? collect()])
        </div>
    </div>
</div>
