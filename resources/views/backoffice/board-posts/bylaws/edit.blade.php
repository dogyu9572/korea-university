    ...
    <div class="board-card">
        <div class="board-card-body">
            ...
            <form action="{{ route('backoffice.board-posts.update', [$board->slug ?? 'notice', $post->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="title" value="{{ $post->title ?? '정관' }}">
                ...
                <input type="hidden" name="author_name" value="{{ old('author_name', $post->author_name ?? auth()->user()->name ?? '관리자') }}">
                    ...
                    <div class="board-file-upload">
                        <div class="board-file-input-wrapper">
                            ...
                            <div class="board-file-input-content">
                                ...
                                <span class="board-file-input-subtext">최대 5개, 각 파일 100MB 이하</span>
                            </div>
                        </div>
