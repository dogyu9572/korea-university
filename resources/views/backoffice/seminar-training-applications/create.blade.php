...
@section('title', '세미나/해외연수 신청내역 (신청 추가)')
...
<div class="board-container education-applications">
    <div class="board-header">
        <a href="{{ $program ?? null ? route('backoffice.seminar-training-applications.show', $program->id) : route('backoffice.seminar-training-applications.index') }}" class="btn btn-secondary btn-sm">
    ...
    <div class="board-card">
        <div class="board-card-body">
            @include('backoffice.seminar-training-applications._form', ['isEdit' => false, 'application' => null, 'program' => $program ?? null, 'programs' => $programs ?? collect()])
        </div>
    </div>
</div>
