...
<div class="board-container">
    ...
    <div class="board-card">
        <div class="board-card-body">
            <form action="{{ route('backoffice.schools.store') }}" method="POST" id="schoolForm">
                @csrf
                            ...
                            <div class="member-form-field">
                                <select class="board-form-control @error('branch') is-invalid @enderror" 
                                    ...
                                    @foreach($branches as $key => $value)
                                        <option value="{{ $key }}" @selected(old('branch') == $key)>{{ $value }}</option>
                                    @endforeach
                                </select>
                                @error('branch')
                            ...
                            <div class="member-form-field">
                                <div class="board-radio-group">
                                    <div class="board-radio-item">
                                        <input type="radio" id="is_member_school_y" name="is_member_school" value="Y" class="board-radio-input" @checked(old('is_member_school') == 'Y') required>
                                        <label for="is_member_school_y">Y</label>
                                    </div>
                                    <div class="board-radio-item">
                                        <input type="radio" id="is_member_school_n" name="is_member_school" value="N" class="board-radio-input" @checked(old('is_member_school', 'N') == 'N')>
                            ...
                            <div class="member-form-field">
                                <select class="board-form-control @error('year') is-invalid @enderror" 
                                    ...
                                    @foreach($years as $key => $value)
                                        <option value="{{ $key }}" @selected(old('year', date('Y')) == $key)>{{ $value }}</option>
                                    @endforeach
                                </select>
                                @error('year')
                                    <div class="invalid-feedback">{{ $message }}</div>
