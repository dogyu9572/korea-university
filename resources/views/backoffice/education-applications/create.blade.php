...
<div class="board-container education-applications">
    <div class="board-header">
        <a href="{{ $program ? route('backoffice.education-applications.show', $program->id) : route('backoffice.education-applications.index') }}" class="btn btn-secondary btn-sm">
