                ...
                <div class="member-form-section">
                    ...
                    <div class="member-form-list">
                        ...
                        <div class="member-form-row">
                            ...
                            <div class="member-form-field">
                                <select name="application_status" id="application_status" class="board-form-control select-full-width" data-auto-save-url="{{ route('backoffice.education-applications.update-status', $program) }}">
            ...
            <div class="board-card-body">
                <div class="member-form-section">
                    ...
                    <div class="action-buttons-right">
                        ...
                        <form method="GET" action="{{ route('backoffice.education-applications.show', $program) }}" class="per-page-form" id="perPageForm">
