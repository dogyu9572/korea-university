                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="board-btn-group">
                                                ...
                                                <form action="{{ route('backoffice.education-applications.destroy', $application) }}" method="POST" class="d-inline" data-action="confirm-delete" onsubmit="return confirm('정말 삭제하시겠습니까?');">
                                                    @csrf
                                                    @method('DELETE')
