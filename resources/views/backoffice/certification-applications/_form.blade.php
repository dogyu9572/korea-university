...
<form action="{{ $isEdit ? route('backoffice.certification-applications.update', $app) : route('backoffice.certification-applications.store') }}" method="POST" enctype="multipart/form-data" id="applicationForm">
    ...
    <div class="board-form-actions">
        ...
        <a href="{{ $isEdit ? route('backoffice.certification-applications.show', $app?->education_program_id) : ($program ? route('backoffice.certification-applications.show', $program->id) : route('backoffice.certification-applications.index')) }}" class="btn btn-secondary">목록</a>
    </div>
</form>
