...
<div class="board-container education-applications">
    <div class="board-header">
        <a href="{{ $program ? route('backoffice.certification-applications.show', $program->id) : route('backoffice.certification-applications.index') }}" class="btn btn-secondary btn-sm">
    ...
    <div class="board-card">
        <div class="board-card-body">
            @include('backoffice.certification-applications._form', ['isEdit' => false, 'application' => null, 'program' => $program ?? null, 'programs' => $programs ?? collect(), 'examVenues' => $examVenues ?? collect()])
        </div>
    </div>
</div>
