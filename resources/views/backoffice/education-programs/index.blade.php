...
<div class="board-container">
    <div class="board-page-header">
        <div class="board-page-buttons">
            <a href="{{ route('backoffice.education-programs.create') }}" class="btn btn-success">
    ...
    <div class="board-card">
        <div class="board-card-body">
                ...
                <div class="board-filter">
                    <form method="GET" action="{{ route('backoffice.education-programs.index') }}" class="filter-form">
                ...
                <div class="board-list-header">
                    ...
                    <div class="list-controls">
                        <form method="GET" action="{{ route('backoffice.education-programs.index') }}" class="per-page-form">
                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="board-btn-group">
                                        <a href="{{ route('backoffice.education-programs.edit', $program) }}" class="btn btn-primary btn-sm">
                                            <i class="fas fa-edit"></i> 수정
                                        </a>
                                        <form action="{{ route('backoffice.education-programs.destroy', $program) }}" method="POST" class="d-inline" onsubmit="return confirm('정말 삭제하시겠습니까?');">
                                            @csrf
                                            @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="11" class="text-center">등록된 교육 프로그램이 없습니다.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
