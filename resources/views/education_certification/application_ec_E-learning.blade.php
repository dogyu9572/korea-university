...
<main class="sub_wrap inner">
	...
	<div class="glbox dl_slice">
		<dl>
			<dt>교육명</dt>
			<dd>산학협력단 연구행정 기초과정(E-learning)</dd>
		</dl>
		<dl>
			<dt>교육기간</dt>
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td class="tac">
						<label class="radio">
							<input type="radio" name="eduPay" checked>
							<i></i>
							<span>60,000원</span>
						</label>
					</td>
				...
				<tr>
					...
					<td class="intbl">
						<table class="tbl_default tbl_tac">
							...
							<tbody>
								<tr>
									<th>교육 시작 30일 전까지 취소</th>
									<td class="refund01">수수료 없음</td>
									<td class="refund02">전액 환불</td>
								</tr>
								<tr>
									<th>교육 시작 7일 전까지 취소</th>
									<td class="refund01">참가비의 25%</td>
									<td class="refund02">부분 환불</td>
								</tr>
								<tr>
									<th>교육 시작 7일 이내 및 당일 취소</th>
									<td class="refund01">참가비 100%</td>
									<td class="refund02 blank">환불 불가</td>
								</tr>
							</tbody>
						</table>
					</td>
