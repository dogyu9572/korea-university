	...
	<div class="tbl th_bg mo_reverse_tbl">
		<table>
			...
			<tbody>
				<tr>
					<th>회원교</th>
					<td class="tac"><label class="radio"><input type="radio" name="eduPay" checked><i></i><span>7,000원</span></label></td>
				</tr>
				<tr>
					<th>비회원교</th>
					<td class="tac"><label class="radio"><input type="radio" name="eduPay"><i></i><span>3,000원</span></label></td>
				</tr>
			</tbody>
		</table>
	</div>
