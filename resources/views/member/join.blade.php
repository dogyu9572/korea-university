		...
		<div class="dl_slice in_inputs member_area">
			...
			<div class="inputs">
				<dl>
					...
					<dd class="inbtn">
						<input type="text" placeholder="이메일을 입력해주세요." value="useremail@example.com">
						<button type="button" class="btn">중복확인</button>
					</dd>
				</dl>
				<dl>
					<dt>비밀번호<span class="c_blue_light">*</span></dt>
					<dd><input type="password" class="w100p" placeholder="영문/숫자/특수문자 조합 두가지 이상(8~10자 이내 입력)"></dd>
				</dl>
				<dl>
					<dt>비밀번호 확인<span class="c_blue_light">*</span></dt>
					<dd><input type="password" class="w100p" placeholder="비밀번호를 한 번 더 입력해주세요."></dd>
				</dl>
				<dl>
				...
				<dl>
					...
					<dd><input type="text" class="w100p" placeholder="이름을 입력해주세요. (최대 8글자)"></dd>
				</dl>
				<dl>
					<dt>주소</dt>
					<dd class="inbtn">
