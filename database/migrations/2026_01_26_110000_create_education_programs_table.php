...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('education_programs', function (Blueprint $table) {
            $table->id();
            $table->string('education_type')->comment('정기교육 / 수시교육 / 자격증 / 온라인교육');
            $table->string('education_class')->nullable()->comment('교육구분(차수 등)');
            ...
            $table->text('content')->nullable()->comment('상세 내용(에디터 HTML)');
