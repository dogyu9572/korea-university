...
class DashboardService
{
    ...
    public function getVisitorStats(): array
    {
        ...
        return [
            'today' => DailyVisitorStat::where('visit_date', $today)->value('visitor_count') ?? 0,
            'yesterday' => DailyVisitorStat::where('visit_date', $yesterday)->value('visitor_count') ?? 0,
            'this_month' => DailyVisitorStat::whereBetween('visit_date', [$thisMonthStart, $thisMonthEnd])->sum('visitor_count'),
            'total' => DailyVisitorStat::sum('visitor_count'),
        ];
    }
